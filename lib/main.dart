...
import 'screens/login_screen.dart'; // Import da nova tela de login e wrapper
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const AuthWrapper(), // Agora usa o Wrapper para decidir se vai para Login ou Game
    );
  }
}
